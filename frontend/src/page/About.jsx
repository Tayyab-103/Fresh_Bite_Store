    ...
    <section>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-lg shadow-lg p-4">
          <img onClick={routeChange} src="https://www.thestar.com/content/dam/thestar/life/food_wine/2017/01/15/fresh-bites-new-apple-brand-pazazz-available-now-in-stores/pazazz-in-apple-basket.jpg" alt="Team Member 1" class="w-full mb-4 rounded-lg"/>
        ...
        <div class="bg-white rounded-lg shadow-lg p-4">
          <img onClick={routeChange} src="https://cdn-prod.medicalnewstoday.com/content/images/articles/271/271157/bananas-chopped-up-in-a-bowl.jpg" alt="Team Member 2" class="w-full mb-4 rounded-lg"/>
        ...
        <div class="bg-white rounded-lg shadow-lg p-4">
          <img onClick={routeChange} src="https://as2.ftcdn.net/v2/jpg/05/64/04/73/1000_F_564047323_IPjf48i1GXM01eLGuI1pAD8EzWHl4S8V.jpg" alt="Team Member 3" class="w-full mb-4 rounded-lg"/>
          <h3 class="text-lg font-semibold">Fresh Vegetables</h3>
          <p class="text-gray-700">Organic, chemical-free and farmer-friendly</p>
        </div>
        <div class="bg-white rounded-lg shadow-lg p-4">
          <img onClick={routeChange} src="https://media.istockphoto.com/id/1309966291/photo/delivery-fast-food-concept.jpg?s=612x612&w=0&k=20&c=TcY_bJDPphPUl1X9PtsWXfLBdmRRcd9wbiOHbuN8O9k=" alt="Team Member 4" class="w-full mb-4 rounded-lg"/>
